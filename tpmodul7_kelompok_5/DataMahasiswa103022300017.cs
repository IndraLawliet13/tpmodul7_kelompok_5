...
public class NamaMahasiswa103022300017
{
    public string depan { get; set; }
    public string belakang { get; set; }
}

public class MahasiswaData103022300017
{
    public NamaMahasiswa103022300017 nama { get; set; }
...
public class DataMahasiswa103022300017
{
    public void ReadJSON()
    {
        ...
        try
        {
            ...
            MahasiswaData103022300017 dataMahasiswa = JsonSerializer.Deserialize<MahasiswaData103022300017>(jsonString);
